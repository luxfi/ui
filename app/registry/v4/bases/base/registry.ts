/**
 * Hanzo UI - Base UI Registry
 *
 * Components built on Base UI primitives from MUI.
 * These are unstyled, accessible components as an alternative to Radix.
 */

import { type Registry, type RegistryItem } from "../../schema"

// UI Components using Base UI
