...
/**
 * Lux ecosystem chains (Lux + Zoo + subnets)
 */
...
/**
 * Explorer API base URLs for each chain
 */
export const EXPLORER_API: Record<number, string> = {
  [luxMainnet.id]: 'https://explore.lux.network',
  [zooMainnet.id]: 'https://explore-zoo.lux.network',
  [hanzoMainnet.id]: 'https://explore-hanzo.lux.network',
  [spcMainnet.id]: 'https://explore-spc.lux.network',
  [parsMainnet.id]: 'https://explore-pars.lux.network',
}
