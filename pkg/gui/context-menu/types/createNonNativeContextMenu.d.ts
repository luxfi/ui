import type BaseMenuTypes from '@gui/create-menu';
import { createBaseMenu, type CreateBaseMenuProps } from '@gui/create-menu';
...
export declare function createNonNativeContextMenu(params: CreateBaseMenuProps): {
    ...
    Trigger: import("@gui/web").GuiComponent<Omit<ViewProps, "scope" | keyof ContextMenuTriggerProps> & ContextMenuTriggerProps & {
        scope?: string;
    }, GuiElement, import("@gui/web").StackNonStyleProps & ContextMenuTriggerProps & {
        scope?: string;
    ...
    Content: React.ForwardRefExoticComponent<ContextMenuContentProps & {
        scope?: string;
    } & React.RefAttributes<(HTMLElement & import("@gui/web").GuiElementMethods) | import("react-native").View>>;
    ...
    Item: React.ForwardRefExoticComponent<Omit<Omit<import("@gui/web").GetFinalProps<import("@gui/web").StackNonStyleProps, import("@gui/web").StackStyleBase, {
        unstyled?: boolean | undefined;
    ...
    CheckboxItem: React.ForwardRefExoticComponent<Omit<Omit<import("@gui/web").GetFinalProps<import("@gui/web").StackNonStyleProps, import("@gui/web").StackStyleBase, {
        unstyled?: boolean | undefined;
    ...
    RadioGroup: React.ForwardRefExoticComponent<Omit<Omit<import("@gui/web").GetFinalProps<import("@gui/web").StackNonStyleProps, import("@gui/web").StackStyleBase, {
        unstyled?: boolean | undefined;
    ...
    RadioItem: React.ForwardRefExoticComponent<Omit<Omit<import("@gui/web").GetFinalProps<import("@gui/web").StackNonStyleProps, import("@gui/web").StackStyleBase, {
        unstyled?: boolean | undefined;
    ...
    ItemIndicator: import("@gui/web").GuiComponent<Omit<Omit<import("@gui/web").GetFinalProps<import("@gui/web").StackNonStyleProps, import("@gui/web").StackStyleBase, {
        ...
        scope?: string;
    } & Omit<Omit<import("@gui/web").GetFinalProps<import("@gui/web").StackNonStyleProps, import("@gui/web").StackStyleBase, {
        unstyled?: boolean | undefined;
    }>, "scope" | keyof BaseMenuTypes.MenuItemIndicatorProps> & BaseMenuTypes.MenuItemIndicatorProps & {
        scope?: string;
    } & React.RefAttributes<GuiElement>, "ref"> & {
    ...
    SubTrigger: import("@gui/web").GuiComponent<Omit<ViewProps, "scope" | "key" | keyof BaseMenuTypes.MenuSubTriggerProps> & Omit<BaseMenuTypes.MenuSubTriggerProps & {
        scope?: string;
    } & React.RefAttributes<GuiElement>, "ref"> & {
        scope?: string;
    }, GuiElement, import("@gui/web").StackNonStyleProps & Omit<BaseMenuTypes.MenuSubTriggerProps & {
        scope?: string;
    } & React.RefAttributes<GuiElement>, "ref"> & {
        scope?: string;
    }, import("@gui/web").StackStyleBase, {}, {}>;
    SubContent: React.ForwardRefExoticComponent<Omit<Omit<import("@gui/web").GetFinalProps<import("@gui/core").RNGuiViewNonStyleProps, import("@gui/web").StackStyleBase, {
