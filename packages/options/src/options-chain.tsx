...
import { cn } from "./cn"
import type { OptionStrike, OptionType } from "./types"
...
export interface OptionsChainProps {
  /** Array of strikes with call/put quotes. */
  strikes: OptionStrike[]
  /** Current spot price of the underlying. Used to highlight ATM/ITM rows. */
  spotPrice: number | null
  /** Called when a user clicks on a call or put row. */
  onSelectOption: (strike: number, side: OptionType) => void
  /** Currently selected strike, if any. */
  selectedStrike: number | null
  /** Currently selected side (call/put), if any. */
  selectedSide: OptionType | null
  className?: string
}
